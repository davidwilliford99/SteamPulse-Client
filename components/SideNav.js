...
const SideNav = () => {
    return (
        <div className="min-h-screen w-52 bg-neutral-900 text-white flex flex-col">
            ...
            <li className="mb-2 pl-3 flex items-center hover:bg-neutral-700 rounded-sm">
                    ...
                    <Link legacyBehavior href="/GlobalDashboard">
                        <a className="block p-2 text-neutral-300 font-semibold">Global Dashboard</a>
                    </Link>
                </li>
                <li className="mb-2 pl-3 flex items-center hover:bg-neutral-700 rounded-sm">
                    <img src='/profile.svg' className="h-6"/>
                    <Link legacyBehavior href="/YourDashboard">
                        <a className="block p-2 text-neutral-300 font-semibold">Your Dashboard</a>
                    </Link>
                </li>
                <li className="mb-2 pl-3 flex items-center hover:bg-neutral-700 rounded-sm">
